      ...
      <section className={`h-16 flex items-center px-4 ${darkMode ? "bg-gray-600":"bg-white"}`}>
        ...
        <div className='relative'>
          ...
          <input 
            type="text"
             placeholder='Message...'
             className={`py-1 px-4 outline-none w-full h-ful ${darkMode && "bg-gray-600 text-white"}`} 
             value={message.text}
             onChange={Handle_typedMessage}
             />

             <button type='submit' className={`${darkMode ? "text-blue-400 hover:text-blue-600": "text-primary hover:text-secondary"}`}>
             <IoMdSend size={25}/>
             </button>
          </form>
